...
$productos = $collection->find(['tipo' => 'raton']);
?>
...
<div class="video-nav-container">
    ...
    <nav class="navbar navbar-expand-lg"> 
        <div class="container-fluid justify-content-center">
          <h2 class="infovideo">RATONES Y MANDOS</h2>
        </div>
    </nav>
</div>
<a href="tienda.php" class="enlacefiltro"><h3 class="filtro sub" id="todos">TODOS</h3></a>
<div class="filtros">
<a href="subratones.php" class="enlacefiltro"><h3 class="filtro"><img src="ico/computer-mouse (1).png" id="raton" class="icofiltro"></h3></a>
