...
$productos = $collection->find(['tipo' => 'cascos']);
?>
...
<a href="subratones.php" class="enlacefiltro"><h3 class="filtro"><img src="ico/computer-mouse.png" id="raton" class="icofiltro"></h3></a>
  <a href="subcascos.php" class="enlacefiltro"><h3 class="filtro"><img src="ico/headphone (1).png" id="cascos" class="icofiltro"></h3></a>
