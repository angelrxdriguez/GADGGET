...
$productos = $collection->find(['tipo' => 'home']);
?>
...
<div class="video-nav-container">
    <video autoplay loop muted playsinline class="video-fondo">
        <source src="video/setups.mp4">
        Tu navegador no soporta videos.
    </video>
    
    <nav class="navbar navbar-expand-lg"> 
        <div class="container-fluid justify-content-center">
          <h2 class="infovideo">LUCES Y MOBILIARIO</h2>
        </div>
    </nav>
</div>
...
<a href="subratones.php" class="enlacefiltro"><h3 class="filtro"><img src="ico/computer-mouse.png" id="raton" class="icofiltro"></h3></a>
  ...
  <a href="subhome.php" class="enlacefiltro"><h3 class="filtro"><img src="ico/home (1).png" id="home" class="icofiltro"></h3></a>
